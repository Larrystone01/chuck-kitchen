export const MenuCategoriesItems = [
  { id: 1, name: "popular" },
  { id: 2, name: "jollof rice & entrees" },
  { id: 3, name: "swallows and soups" },
  { id: 4, name: "grills & sides" },
  { id: 5, name: "beverages" },
  { id: 6, name: "desserts" },
];

export const PopularCategoryItems = [
  {
    id: 1,
